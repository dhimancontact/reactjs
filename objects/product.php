...
class Product{
    ...
    public function readAll(){
        ...
        //select all data
        $query = "SELECT p.id, p.name, p.description, p.price, c.name as category_name FROM ";
        $query .= "" . $this->table_name . " p LEFT JOIN categories c ON p.category_id=c.id ORDER BY id DESC";
